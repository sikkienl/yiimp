...
#ifndef STRATUM_UPDATEPASS
	#define STRATUM_UPDATEPASS "tu8tu5"
#endif
...
int main(int argc, char **argv)
{
	...
	*p = 0;
	...
	char buffer[1024];
	sprintf(buffer, "{\"id\":1,\"method\":\"mining.update_block\",\"params\":[\"%s\",%d,\"%s\"]}\n",STRATUM_UPDATEPASS , coinid, blockhash);
