    ...
    build_light_cache_fn build_fn, int epoch_number, bool full) noexcept
{
    ...
    const int light_cache_num_items = is_meowpow ? calculate_light_cache_num_items(meow_epoch) : calculate_light_cache_num_items(epoch_number);
    const int full_dataset_num_items = is_meowpow ? calculate_full_dataset_num_items(meow_epoch): calculate_full_dataset_num_items(epoch_number);
